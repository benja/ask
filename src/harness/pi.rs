...
impl Pi {
    pub fn from_environment() -> Self {
        Self {
            program: std::env::var_os("ASK_PI_BIN").unwrap_or_else(|| "pi".into()),
        }
    }

    pub fn is_available() -> bool {
        let program = std::env::var_os("ASK_PI_BIN").unwrap_or_else(|| "pi".into());
...
mod tests {
    ...
    #[test]
    fn combines_read_only_tools_with_ask_instructions() {
        let harness = Pi {
            program: "pi".into(),
        };
