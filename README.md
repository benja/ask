...
Answers go to stdout. Prompts and errors go to stderr, so one-shot answers are safe to pipe. Agents can inspect the current directory but cannot modify it.
